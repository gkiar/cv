...
Integration of distributed software software services with the Amazon Web Services (AWS) cloud.}
\end{entrylist}
...
Contributed to the organization and planning of a BrainHack 101 training course and unconference activities related to
open science throughout the annual OHBM meeting.}
\end{entrylist}
