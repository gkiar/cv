...
{Thesis work supervised by Alan Evans and Tristan Glatard on a project entitled:\\ Characterizing
and Optimizing Generalizability and Accuracy in Neuroimaging Through Repeated Provenance-rich Analysis.
...
{Running workshops in the context of an accessible instructional pedagogy.}
...
computing clouds and clusters. Provided development, training, and support towards the use of tools
and services within international collaborations.}
 % \end{entrylist}
...
{Minneapolis, MN}
{\job{Open Science Special Interest Group Hackathon Chair} \\
Responsible for organizing and planning an introductory neuroinformatics course for neuroscientists,
BrainHack 101, an international ``hackathon'' style event for collaborative neuroinformatics training
and project development, and curation of unconference activities related to the open science special
interest group before and throughout the annual OHBM meeting.}
\end{entrylist}
...
\entry
{05/17 -- now}
{McGill University, OHBM, Brain Intensive, Universite de Montreal, others}
{Montreal, QC}
