...
\href{https://twitter.com/g_kiar}{g\_kiar~{\color{blue} \faTwitter}}
\href{https://www.linkedin.com/in/gregkiar}{gregkiar~{\color{green} \faLinkedin}}
\section{languages}
...
Ruby, LaTeX
\section{soft skills}
leadership, teaching, sci.~communication, problem~solving, design
\end{aside}
...
{Minneapolis, MN}
{\job{Open Science SIG - BrainHack Co-Chair} \\
...
{Montreal, QC}
{Neuroinformatics Representative}
